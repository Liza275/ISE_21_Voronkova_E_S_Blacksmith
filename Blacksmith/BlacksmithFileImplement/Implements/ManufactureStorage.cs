    ...
    public class ManufactureStorage : IManufactureStorage
    {
        ...
        private Manufacture CreateModel(ManufactureBindingModel model, Manufacture manufacture)
        {
            ...
            foreach (var component in model.ManufactureComponents)
            {
                ...
                {
                    manufacture.ManufactureComponents[component.Key] = model.ManufactureComponents[component.Key].Item2;
                }
                else
                {
                    manufacture.ManufactureComponents.Add(component.Key, model.ManufactureComponents[component.Key].Item2);
                }
            }
            return manufacture;
        }
        ...
        private ManufactureViewModel CreateModel(Manufacture manufacture)
        {
            return new ManufactureViewModel
            {
                ...
                ManufactureComponents = manufacture.ManufactureComponents.ToDictionary(recCC => recCC.Key, recCC =>
