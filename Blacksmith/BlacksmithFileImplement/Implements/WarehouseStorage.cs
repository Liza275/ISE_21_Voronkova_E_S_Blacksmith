...
namespace BlacksmithFileImplement.Implements
{
    public class WarehouseStorage : IWarehouseStorage
    {
        ...
        private Warehouse CreateModel(WarehouseBindingModel model, Warehouse warehouse)
        {
            ...
            warehouse.ManagerFullName = model.ResponsiblePersonFCS;
        ...
        private WarehouseViewModel CreateModel(Warehouse warehouse)
        {
            ...
            return new WarehouseViewModel
            {
                ...
                ResponsiblePersonFCS = warehouse.ManagerFullName,
        ...
        public bool CheckComponentsCount(int count, Dictionary<int, (string, int)> components)
        {
            ...
            {
                int compCount = source.Warehouses.Where(wh => wh.WarehouseComponents.ContainsKey(component.Key)).Sum(wh => wh.WarehouseComponents[component.Key]);
            ...
            foreach (var component in components)
            {
                ...
                {
                    var warehouse = source.Warehouses.FirstOrDefault(wh => wh.WarehouseComponents.ContainsKey(component.Key) && wh.WarehouseComponents[component.Key] > 0);
